...
export const getBluefinUserLpPositions = tool({
  description:
    'Get the user lp positions in Bluefin Exchange. Pass in the wallet address to view positions.',
  parameters: z.object({
    walletAddress: z.string().describe('The wallet address to get LP positions for')
  }),
